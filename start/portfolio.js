...
const registerAgmMethod = () => {
    ...
    // Register the AGM method only if you are not in activity, otherwise listen for activity context changes and call loadPortfolio
...
const invokeAgmMethodByName = (methodName, params) => {
