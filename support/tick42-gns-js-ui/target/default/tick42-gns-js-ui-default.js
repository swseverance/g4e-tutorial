...
},{"./dates":1}],3:[function(require,module,exports){
/**
...
},{"../gns/utilityGns":7,"./dates":1,"./icons":2}],5:[function(require,module,exports){
...
},{"../common/dates":1,"../common/initGlue":3,"../common/templateHelpers":4,"../gns/utilityGns":7}],6:[function(require,module,exports){
;return;
...
window.applyUxWidgets = function() {
    $('[data-toggle="tooltip"]').tooltip()
}

window.focusAnimation = function(){
//            $('body').children().effect('highlight', {easing: 'linear'}, 700)
//            $('.well').effect('highlight', {easing: 'linear'}, 700)
}

//        window.addEventListener("unload", function closeSelf(event) {
//            window.removeEventListener('unload', closeSelf)
//            window.close()
//        })

window.initInvokers = function(){
    ...
    function specialMethodHandler(e){
        ...
        invokeGlueRoutingMethod(method, nif)
    }
...
},{"../gns/utilityGns":7}],7:[function(require,module,exports){
...
},{"js-logger":8}],8:[function(require,module,exports){
/*!
