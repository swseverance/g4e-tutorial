(function webpackUniversalModuleDefinition(root, factory) {
  ...
  ([
    ...
    (function(module, exports, __webpack_require__) {
      ...
      var tick42_windows_1 = __webpack_require__(30);
      ...
      exports.default = function(options) {
        ...
        function createWindows(core) {
          if (glueConfig.windows) {
            ...
            _windows = tick42_windows_1.default(core.agm, windowsLogger, function() {
              return _appManager;
            });
            debugLog(_windows);
            return _windows;
    ...
    (function(module, exports) {
      ...
      module.exports = { "_args": [
          [{ "raw": "tick42-activity@2.12.10", "scope": null, "escapedName": "tick42-activity", "name": "tick42-activity", "rawSpec": "2.12.10", "spec": "2.12.10", "type": "version" }, "D:\\work\\stash\\GLUE-dev\\dev\\js-glue"]
        ], "_from": "tick42-activity@2.12.10", "_id": "tick42-activity@2.12.10", "_inCache": true, "_location": "/tick42-activity", "_phantomChildren": {}, "_requested": { "raw": "tick42-activity@2.12.10", "scope": null, "escapedName": "tick42-activity", "name": "tick42-activity", "rawSpec": "2.12.10", "spec": "2.12.10", "type": "version" }, "_requiredBy": ["/"], "_resolved": "https://repo.tick42.com:443/api/npm/tick42-npm/tick42-activity/-/tick42-activity-2.12.10.tgz", "_shasum": "2aebf5f4bb77316c48dedd054c8e1c3c5bb528dc", "_shrinkwrap": null, "_spec": "tick42-activity@2.12.10", "_where": "D:\\work\\stash\\GLUE-dev\\dev\\js-glue", "author": { "name": "Tick42", "url": "http://www.tick42.com" }, "bin": { "build": "./bin/build.js", "clean": "./bin/clean.js", "file-versionify": "./bin/file-versionify.js", "minify": "./bin/minify.js" }, "bugs": { "url": "https://jira.tick42.com/browse/APPCTRL" }, "dependencies": {}, "description": "Tick42 Activities", "devDependencies": { "blanket": "^1.1.6", "browserify": "^13.0.0", "browserify-replacify": "^0.0.4", "browserify-versionify": "^1.0.4", "docdash": "^0.4.0", "jsdom": "^8.1.0", "jshint": "^2.9.5", "minifyify": "^7.3.2", "onchange": "^2.1.2", "phantomjs": "^1.9.12", "pre-commit": "^1.1.3", "qunitjs": "^1.15.0", "shelljs": "^0.6.0", "tsd": "^0.6.4", "tslint": "^2.5.1", "typescript": "^2.5.3", "uglifyify": "^3.0.1" }, "dist": { "tarball": "https://repo.tick42.com:443/api/npm/tick42-npm/tick42-activity/-/tick42-activity-2.12.10.tgz", "shasum": "2aebf5f4bb77316c48dedd054c8e1c3c5bb528dc" }, "docName": "Activities", "keywords": ["javascript", "library"], "main": "library_js/activityModule.js", "name": "tick42-activity", "optionalDependencies": {}, "precommit": "lint", "readme": "ERROR: No README data found!", "repository": { "url": "https://stash.tick42.com/scm/tact/js-actvitiy.git" }, "scripts": { "build": "npm run compile:ts & node bin/clean.js & node bin/build.js & node bin/minify & node bin/file-versionify", "compile:ts": "tsc --project ./library/", "generate-docs": "npm run build && jsdoc -c jsdoc-config.json", "lint": "jshint library", "prepublish": "npm update & npm run build", "test": "npm run lint & mocha --require ./test/test_helper \"test/**/*.js\"", "watch": "onchange \"./library/*.ts\" -iv -e \"./bin\" -- npm run build", "watch:ts": "tsc -w --project ./library/" }, "title": "Activities", "types": "./types/index.d.ts", "version": "2.12.10" }
    ...
    (function(module, exports, __webpack_require__) {
      ...
      var ActivityMy = /** @class */ (function() {
        function ActivityMy(manager, windows) {
          ...
          this._logger = logger_1.Logger.Get("my");
          this._m = manager;
          manager.ready()
            .then(function(am) {
        ...
        ([
          ...
          (function(module, exports) {
            ...
            module.exports = {
              ...
              "devDependencies": {
                "@types/node": "^8.0.26",
                "@types/tick42-activity": "*",
                "@types/tick42-windows": "*",
                "dts-generator": "^2.1.0",
                "http-server": "^0.9.0",
                "json-loader": "^0.5.4",
                "onchange": "3.*",
        ...
        ([
          ...
          (function(module, exports, __webpack_require__) {
            ...
            (function(process, global) {
              ...
              /* WEBPACK VAR INJECTION */
            }.call(exports, __webpack_require__(15), __webpack_require__(2)))
          ...
          (function(module, exports, __webpack_require__) {
            ...
            var GlueCore = function(userConfig, ext) {
              ...
              ext = ext || {};
              var internalConfig = config_1.default(userConfig, ext, hc, gd);
              // Init the GLUE namespace
              var _connection;
              var _agm;
              var _logger;
              ...
              function setupConnection() {
                ...
                if (internalConfig.connection && !internalConfig.auth) {
                  ...
                  if (protocolVersion === 3) {
                    if (gd) {
                      authPromise = gd.getGWToken().then(function(token) {
                        return {
                          gatewayToken: token
                        };
                      });
          ...
          (function(module, exports) {
            ...
            module.exports = { "name": "tick42-glue-core", "version": "3.11.6", "description": "Glue42 core library including logger, connection, agm and metrics", "main": "./dist/node/tick42-glue-core.js", "types": "./types/glue.d.ts", "browser": "./dist/web/tick42-glue-core.js", "scripts": { "init-dev-mode": "node ./build/scripts/init-dev-mode.js", "remove-installed-dependencies": "node ./build/scripts/remove-installed-dependencies.js", "clean": "node ./build/scripts/clean.js", "pre:build": "npm run clean && npm run tslint && tsc && set NODE_ENV=development", "file-versionify": "node ./build/scripts/file-versionify.js", "tslint": "tslint -t codeFrame ./src/**.ts", "tslint:fix": "tslint -t codeFrame --fix ./src/**.ts", "watch": "onchange ./src/**/*.ts -- npm run build:dev", "build:dev": "npm run pre:build && set NODE_ENV=development && webpack && npm run file-versionify && npm run types", "build:prod": "npm run pre:build && set NODE_ENV=development && webpack && set NODE_ENV=production && webpack && npm run types && npm run file-versionify", "docs": "typedoc --options typedoc.json ./src", "prepublish": "npm run build:prod && npm run test:only", "types": "node ./build/scripts/copy-types.js", "test": "npm run build:dev && npm run test:only", "test:only": "mocha ./tests/ --recursive", "test:core": "mocha ./tests/core", "test:agm": "mocha ./tests/agm" }, "repository": { "type": "git", "url": "https://stash.tick42.com/scm/tg/js-glue-core.git" }, "author": { "name": "Tick42", "url": "http://www.glue42.com" }, "license": "ISC", "dependencies": { "shortid": "^2.2.6", "callback-registry": "^2.3.1", "util-deprecate": "^1.0.2", "ws": "^0.7.2" }, "devDependencies": { "@types/shortid": "0.0.29", "archiver": "^1.3.0", "babel-core": "^6.25.0", "babel-loader": "^6.4.1", "babel-plugin-add-module-exports": "^0.2.1", "babel-preset-es2015": "^6.16.0", "babel-preset-stage-2": "^6.22.0", "chai": "^4.0.2", "deep-equal": "^1.0.1", "mocha": "^2.5.3", "onchange": "3.*", "pre-commit": "^1.1.3", "readline-sync": "^1.4.5", "shelljs": "^0.6.0", "tick42-gateway": "^0.2.2", "tick42-webpack-config": "4.1.6", "tslint": "^5.4.3", "typedoc": "^0.5.10", "typescript": "2.7.2", "webpack": "2.3.3" } }
            ...
            (function(global) {
              ...
              function createOwnInstance(userSubmittedProperties, resolvedIdentity, peerId) {
                ...
                if (typeof resolvedIdentity !== "undefined") {
                  ...
                  instance.pid = resolvedIdentity.pid;
          ...
          (function(module, exports, __webpack_require__) {
            ...
            (function(global) {
              ...
              function default_1(configuration, ext, hc, gd) {
                if (typeof window !== "undefined") {
          ...
          (function(module, exports, __webpack_require__) {
            ...
            (function(global) {
              Object.defineProperty(exports, "__esModule", { value: true });
              var callback_registry_1 = __webpack_require__(0);
              var WebSocket = isNode() ? __webpack_require__(23) : global.WebSocket;
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        ...
        ([
              ...
              LayoutsAPIImpl.prototype.save = function(layout) {
                ...
                return new Promise(function(resolve, reject) {
                  ...
                  if (layout.type === "Activity") {
                    ...
                    if (layout.ignoreWindows) {
                      instances = instances.filter(function(i) {
                        return layout.ignoreWindows.indexOf(i.id) === -1;
                      })
                    }
          ...
          (function(module, exports) {
            ...
            module.exports = { "name": "tick42-layouts", "version": "1.8.3", "description": "", "main": "./dist/web/tick42-layouts.js", "types": "types/index.d.ts", "docName": "Layouts", "scripts": { "tslint": "tslint -t codeFrame ./src/**/*.ts", "clean": "node ./build/scripts/clean.js", "tslint:fix": "tslint -t codeFrame --fix ./src/**/*.ts", "pre:build": "npm run tslint && tsc && set NODE_ENV=development && npm run clean", "build:dev": "npm run pre:build && set NODE_ENV=development && webpack && npm run types", "build:prod": "npm run pre:build && set NODE_ENV=development && webpack && set NODE_ENV=production && webpack && npm run types", "generate-docs": "jsdoc -c jsdoc-config.json", "prepublish": "npm run build:prod", "preversion": "npm run build:prod", "types": "node ./build/scripts/copy-types.js" }, "author": "", "license": "ISC", "devDependencies": { "@types/shortid": "0.0.29", "eslint": "^3.1.1", "eslint-config-standard": "^5.3.5", "eslint-config-tick42": "^1.0.0", "eslint-plugin-promise": "^2.0.0", "eslint-plugin-standard": "^2.0.0", "json-loader": "^0.5.4", "pre-commit": "^1.1.3", "shelljs": "^0.6.0", "tick42-activity": "^2.12.4", "tick42-app-manager": "^3.6.4", "tick42-gateway-connection": "^2.4.4", "tick42-webpack-config": "4.1.6", "tick42-windows": "^4.0.4", "tick42-glue-core": "3.11.3", "tslint": "^5.4.3", "typescript": "^2.5.3", "webpack": "2.3.3" }, "dependencies": { "@types/node": "^8.0.26", "callback-registry": "^2.3.1", "shortid": "^2.2.8" } }
        ...
        ([
          ...
          (function(module, exports) {
            ...
            module.exports = {
              ...
              "main": "dist/node/tick42-windows.js",
              "browser": "dist/web/tick42-windows.js",
              "types": "types/index.d.ts",
              "docName": "Windows",
              "scripts": {
                "clean": "node ./build/scripts/clean.js",
                ...
                "types": "node ./build/scripts/copy-types.js",
                "types:merged": "dts-generator --project ./ --out ./types/index.d.ts",
                "prepublish": "npm run build:prod && npm run types"
              },
              "author": "Tick42",
              "license": "ISC",
          ...
          (function(module, exports, __webpack_require__) {
            ...
            Object.defineProperty(exports, "__esModule", { value: true });
            var hc_1 = __webpack_require__(6);
          ...
          (function(module, exports, __webpack_require__) {
            ...
            var executor_1 = __webpack_require__(5);
          ...
          (function(module, exports, __webpack_require__) {
            ...
            exports.default = function(agm, logger, appManagerGetter) {
              ...
              function open(name, url, options, success, error) {
                return new Promise(function(resolve, reject) {
                  var errorHandler = function(errorResposne) {
                    if (typeof error === "function") {
                      error(errorResposne);
                    }
                    reject(errorResposne);
                  };
