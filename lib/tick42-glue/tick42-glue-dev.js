...
module.exports = {"name":"tick42-app-manager","version":"3.6.5","description":"A library for interacting with the Glue ACS via agm methods.","main":"dist/node/tick42-app-manager.js","browser":"dist/web/tick42-app-manager.js","types":"types/index.d.ts","docName":"AppManager","scripts":{"clean":"node ./build/scripts/clean.js","pre:build":"npm run tslint && tsc && set NODE_ENV=development && npm run clean","file-versionify":"node ./build/scripts/file-versionify.js","tslint":"tslint -t codeFrame ./src/**/*.ts","tslint:fix":"tslint -t codeFrame --fix ./src/**/*.ts","watch":"onchange ./src/**/*.ts -- npm run build:dev","build:dev":"npm run pre:build && set NODE_ENV=development && webpack && npm run file-versionify && npm run types","build:prod":"npm run pre:build && set NODE_ENV=development && webpack && set NODE_ENV=production && webpack && npm run file-versionify && npm run types","docs":"typedoc --options typedoc.json ./src","types":"node ./build/scripts/copy-types.js","types:merged":"dts-generator --project ./ --out ./types/index.d.ts","prepublish":"npm run build:prod"},"author":"Tick42","license":"ISC","precommit":"tslint","devDependencies":{"@types/node":"^8.0.26","dts-generator":"^2.1.0","http-server":"^0.9.0","json-loader":"^0.5.4","onchange":"3.*","pre-commit":"^1.1.3","shelljs":"^0.6.0","tick42-activity":"^2.12.4","tick42-agm":"^3.5.17","tick42-gateway-connection":"^2.2.14","tick42-logger":"^3.0.8","tick42-webpack-config":"4.1.6","tick42-windows":"3.3.7","tslint":"5.*","typedoc":"^0.5.10","typescript":"2.4.2","webpack":"2.3.3"},"dependencies":{"callback-registry":"^2.3.1","tick42-promisify":"1.0.3"}}
...
var ApplicationImpl = (function () {
    ...
    Object.defineProperty(ApplicationImpl.prototype, "mode", {
        get: function () {
            ...
            // check definition
            if (this._props.Arguments && this._props.Arguments.mode) {
                return this._props.Arguments.mode;
            }
    ...
    ApplicationImpl.prototype.start = function (context, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this._agm.invoke(AgmNames.StartApplicationMethodName, {
                ...
                if (acsResult) {
                    var instances = _this._appManager.instances().filter(function (i) { return i.id === acsResult.Id; });
                    var instance = instances[0];
                    // if activity we have two instances with the same id
                    if (instances.length === 2) {
                        instance = instances[0].isActivityInstance ? instances[0] : instances[1];
                    }
                    resolve(instance);
                }
                else {
...
var HcExecutor = (function () {
    ...
    Object.defineProperty(HcExecutor.prototype, "agmInstance", {
        get: function () {
    ...
    HcExecutor.prototype.showLoader = function (resultWindow, loader) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return _this.agmAction(resultWindow, "T42.Wnd.UpdateLoader", successHandler, errorHandler, { argsForSend: argsForSend });
        });
    };
    ...
    return new Promise(function (resolve, reject) {
        ...
        function updateWindow(eventType, windowInfo) {
            ...
            if (eventType === "TabDettached") {
                ...
                theWindowEvents.handleDetached();
